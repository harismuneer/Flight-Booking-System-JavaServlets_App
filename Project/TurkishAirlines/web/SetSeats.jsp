<%-- 
    Document   : SetSeats
    Created on : Nov 6, 2017, 6:58:27 PM
		  ...
		  <tbody>
                        ...
                        <%
                            ...
                            for (int i = 0; i < flights.size(); i++)
                            {
                                ...
                                out.print("  <input type='number' name='seats_e' min='0' max='50' placeholder='0-50' required value='" + flights.get(i).getEconomySeats() + "' > </td>");
                                ...
                                out.print("  <input type='number' name='seats_b' min='0' max='50' placeholder='0-50' required value='" + flights.get(i).getBusinessSeats() + "' > </td>");
                                ...
                                out.print("  <input type='number' name='seats_f' min='0' max='50' placeholder='0-50' required value='" + flights.get(i).getFirstSeats() + "' > </td>");
                                ...
                                {
                                    out.print("<td><button class='btn btn-primary flex-row-reverse' type='submit'>Change</button></td>");                                
                                }
                                else if(flights.get(i).isChanged)
                                {
                                    out.print("<td>Approval Pending</td>");
                                }
                                else
                                {
                                    out.print("<td>Can't be changed</td>");
                                }
                                out.print("</tr>");
                                out.print("</form>");
                            }
